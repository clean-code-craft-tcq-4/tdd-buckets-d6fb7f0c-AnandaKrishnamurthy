...
namespace Consecutive_No_Range_Checker
{
    class Consecutive_Range_Check
    {
        ...
        Dictionary<string, int[]> Saparate_Cosecutive_Numbers_With_Ranges(int[] iCurrentSamples)
        {
            int Array_Elements = 0;
            List<int> Samples_Buffer_1 = new List<int>();
            List<int> Samples_Buffer_2 = new List<int>();
        ...
        void Is_Input_Data_Valid_Array(List<int> UserList, string inputString, string[] inputString_Array, int i)
        {
            int result;
        ...
        List<int> Evaluate_Convert_To_Int_Input_Data()
        {
            ...
            for (int i = 0; i < input_Var1.ToList().Count; i++)
            {
                ...
                Is_Input_Data_Valid_Array(UserList, input_Var, input_Var1, i);
